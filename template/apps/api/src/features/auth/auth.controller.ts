import type { FastifyRequest,FastifyReply } from "fastify"; import { authService } from "./auth.service.js"; import type { TRegister,TLogin,TRefresh,TGoogleCallback } from "./auth.schema.js";
export const authController={
  ...
  googleCallback:async(req:FastifyRequest<{Body:TGoogleCallback}>,reply:FastifyReply)=>reply.send(await authService.loginWithGoogle(req.body.accessToken)),
