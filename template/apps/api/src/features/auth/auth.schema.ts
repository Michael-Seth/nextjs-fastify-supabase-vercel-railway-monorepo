...
export const GoogleCallbackBody=Type.Object({accessToken:Type.String({minLength:1})});
export type TRegister=Static<typeof RegisterBody>; export type TLogin=Static<typeof LoginBody>; export type TRefresh=Static<typeof RefreshBody>; export type TGoogleCallback=Static<typeof GoogleCallbackBody>;
