import type { FastifyInstance } from "fastify"; import { authController } from "./auth.controller.js"; import { authenticate } from "../../middleware/authenticate.js"; import { RegisterBody,LoginBody,RefreshBody,GoogleCallbackBody } from "./auth.schema.js";
export async function authRoutes(app:FastifyInstance){
  ...
  app.post("/google/callback",{schema:{body:GoogleCallbackBody,tags:["Auth"],summary:"Google OAuth callback"},handler:authController.googleCallback});
